...
import { getAllConnectionActivity, getMyConnections, getPendingRequests, getSentRequests, reviewRequest, sendRequest } from '../../controllers/request.controller.js';
...
requestRouter.get('/getMyConnections', getMyConnections);
